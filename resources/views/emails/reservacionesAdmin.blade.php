...
<div class="container">
  ...
  <div class="content">
    ...
    <p>
      Se ha registrado una nueva <strong>reservación en mostrador</strong>.
    </p>
    ...
    <div class="info-box">
      ...
      <p>Nombre: {{ $reservacion->nombre_cliente ?? '-' }}</p>
      ...
      <p><strong>Tarifa base catálogo:</strong> ${{ number_format($reservacion->tarifa_base, 2) }} MXN</p>

      @if($reservacion->tarifa_modificada)
        <p><strong>Tarifa modificada:</strong> ${{ number_format($reservacion->tarifa_modificada, 2) }} MXN</p>
      @endif

      <p><strong>Tarifa ajustada:</strong> {{ $reservacion->tarifa_ajustada ? 'Sí' : 'No' }}</p>

      <br>

      <p><strong>Estado:</strong> Pendiente de pago en mostrador</p>
