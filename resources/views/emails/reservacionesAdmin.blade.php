...
========================= */
        ...
        .info-section-list {
            margin: 0 0 12px;
            padding-left: 18px;
            /* para que se vean bien las viñetas */
        }
...
========================= */
        ...
        .footer-social {
            font-size: 0;
            /* para quitar espacios entre imgs */
        }
        ...
        <div class="content">
            ...
            <div class="hero">
                ...
                <p class="lead" style="margin-top:0;">
                    ...
                    cualquier modificación relacionada con lo que esta reservación describe podría resultar en una
                    variación contra el precio acordado.
                </p>
            </div>
                ...
                <table role="presentation" style="width:100%; border-collapse:collapse;">
                    <tr>
                        ...
                        <td style="width:45%; vertical-align:middle; padding:10px 0;">
                            <img src="{{ $imgCategoria ?? rtrim(config('app.url'), '/') . '/img/categorias/placeholder.png' }}"
                                alt="Vehículo"
                        ...
                        <td style="width:55%; vertical-align:middle; padding:10px 0 10px 10px;">
                            ...
                            <div class="auto-specs">
                                ...
                                <div class="muted">{{ $tuAuto['transmision'] ?? 'Transmisión manual o automática' }}
                                </div>
                                        ...
                                        <table role="presentation" style="width:100%; border-collapse:collapse;">
                                            <tr>
                                                ...
                                                <td style="width:26px; vertical-align:top; padding-top:2px;">
                                                    <div
                                                        style="width:18px; height:18px; background:#b1060f; border:2px solid #b1060f; border-radius:3px;">
                                                    </div>
                                                </td>
                                                ...
                                                <td style="vertical-align:top;">
                                                    <div
                                                        style="font-weight:800; font-size:14px; color:#111; line-height:1.2;">
                                                        {{ $c['nombre'] }}
                                                    </div>
                                                    @if (!empty($c['precio']))
                                                        <div
                                                            style="font-size:13px; opacity:.85; color:#111; margin-top:2px;">
                                                            {{ $c['precio'] }}
                                                        </div>
                                                    @endif
                                                </td>
...
========================= --}}
                @if ($segCard)
                    ...
                    <div
                        style="font-size:12px; font-weight:800; letter-spacing:.4px; text-transform:uppercase; opacity:.85; margin:14px 0 8px;">
                        Paquete de seguro
                    </div>
                ...
                <div class="info-section">
                    ...
                    <ul class="info-section-list">
                        <li>Tarjeta de crédito: Con un mínimo de antigüedad de un año, todas nuestras rentas deben ser
                            amparadas con una tarjeta de crédito.</li>
                        ...
                        <li>Relevos de responsabilidad: Elegir entre nuestras opciones de protección para el auto (100%,
                            90%, 80% o 0%).</li>
                    </ul>

                    <p class="info-section-paragraph">
                        Los requisitos de renta pueden variar, si requieres más información comunícate al 01 (442) 303
                        26 68
                    ...
                    <p class="info-section-paragraph">
                        ...
                        necesidades y presupuesto. Pregunta por nuestros relevos de responsabilidad (opcionales) al
                        llegar
