    ...
    <section class="section">
        ...
        <div class="box">
            <p class="clause">
                ...
                El presente convenio tiene por objeto establecer los términos bajo los cuales EL ARRENDADOR podrá proporcionar a EL CLIENTE servicios de arrendamiento de vehículos.
            </p>

            <p class="clause">
                <span class="clause-number">SEGUNDA. TARIFAS.</span>
                Las tarifas aplicables serán aquellas señaladas en el anexo correspondiente del presente convenio.
            </p>

            <p class="clause">
                <span class="clause-number">TERCERA. USO DEL VEHÍCULO.</span>
                EL CLIENTE se obliga a utilizar el vehículo de forma responsable, conforme a la ley y a las condiciones pactadas.
            </p>

            <p class="clause">
                <span class="clause-number">CUARTA. RESPONSABILIDAD.</span>
                EL CLIENTE será responsable por daños, multas, cargos, faltantes o cualquier uso indebido del vehículo durante el periodo de renta.
            </p>

            <p class="clause">
                <span class="clause-number">QUINTA. DEVOLUCIÓN.</span>
    ...
    <section class="section">
        ...
        <div class="box">
            @foreach($clausulas as $clausula)
                <p class="clause">
                    <span class="clause-number">{{ $clausula->orden }}.</span>
                    ...
                    <td class="signature-cell">
                        ...
                        <div class="signature-box">
                            ...
                            @if(!empty($convenio->firma_representante))
                                <img
                                    class="signature-img"
                                    src="{{ $convenio->firma_representante }}">
                            @endif
