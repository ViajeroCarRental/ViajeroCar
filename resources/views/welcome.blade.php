  ...
  <section aria-label="Explora destinos y servicios">
      <div class="swiper vj-tiles-swiper">
          <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                  <article class="tile-card">
                      <div class="tile-media" style="background-image:url('{{ asset('img/Urvancard.png') }}')">
                      </div>
                      <div class="tile-body">
              ...
              <div class="swiper-slide">
                  <article class="tile-card">
                      <div class="tile-media" style="background-image:url('{{ asset('img/tarjeta.png') }}')">
                      </div>
                      <div class="tile-body">
                          ...
                          <a
                              href="{{ route('rutaReservasIniciar', ['from' => 'welcome'], ['step' => 1, 'tipo' => 'tarjetas']) }}"class="tile-link">{{ __('Learn about our options...') }}</a>
                      </div>
                  </article>
              </div>
              ...
              <div class="swiper-slide">
                  <article class="tile-card">
                      <div class="tile-media" style="background-image:url('{{ asset('img/Aeropuerto.png') }}')">
                      </div>
                      <div class="tile-body">
                          ...
                          <a
                              href="{{ route('rutaReservasIniciar', ['from' => 'welcome'], ['step' => 1, 'tipo' => 'aeropuerto']) }}"class="tile-link">{{ __('Schedule delivery...') }}</a>
                      </div>
                  </article>
              </div>
              ...
              <div class="swiper-slide">
                  <article class="tile-card">
                      <div class="tile-media" style="background-image:url('{{ asset('img/Verificacion.png') }}')">
                      </div>
                      <div class="tile-body">
              ...
              <div class="swiper-slide">
                  <article class="tile-card">
                      ...
                      <div class="tile-body">
                          ...
                          <a
                              href="{{ route('rutaReservasIniciar', ['from' => 'welcome'], ['step' => 1, 'tipo' => 'dropoff']) }}"class="tile-link">{{ __('Check destinations...') }}</a>
                      </div>
                  </article>
              </div>
              ...
              <div class="swiper-slide">
                  <article class="tile-card tile-reviews">
                      <div class="tile-media" style="background-image:url('{{ asset('img/Prioridad.png') }}')">
                      </div>
