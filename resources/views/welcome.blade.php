...
<section class="v-inicio" data-title="{{ __('messages.inicio') }}">
  ...
  <div class="rv-banner-wrap" id="rvWrap" aria-live="polite">
    <div class="rv-banner" id="rvBanner" role="status" aria-label="{{ __('messages.reservas_en_vivo') }}">
      ...
      <div class="rv-row">
        ...
        <button class="rv-close" id="rvClose" aria-label="{{ __('messages.cerrar') }}">✕</button>
      </div>
    </div>
  </div>
  <!-- ===== /Banner Reservas ===== -->
      ...
      <div class="fleet-track">
        <article class="car-card">
          <header class="car-title">
            ...
            <p>Chevrolet Aveo {{ __('messages.o_similar') }} | C</p>
          </header>
          <div class="car-media">
            <img src="{{ asset('img/aveo.png') }}" alt="Chevrolet Aveo {{ __('messages.o_similar') }}">
          </div>
        ...
        <article class="car-card">
          <header class="car-title">
            ...
            <p>Volkswagen Virtus {{ __('messages.o_similar') }} | D</p>
          </header>
          <div class="car-media">
            <img src="{{ asset('img/virtus.png') }}" alt="Volkswagen Virtus {{ __('messages.o_similar') }}">
          </div>
        ...
        <article class="car-card">
          <header class="car-title">
            ...
            <p>Volkswagen Jetta {{ __('messages.o_similar') }} | E</p>
          </header>
          <div class="car-media">
            <img src="{{ asset('img/jetta.png') }}" alt="Volkswagen Jetta {{ __('messages.o_similar') }}">
          </div>
        ...
        <article class="car-card">
          <header class="car-title">
            ...
            <p>Toyota Camry {{ __('messages.o_similar') }} | F</p>
          </header>
          <div class="car-media">
            <img src="{{ asset('img/camry.png') }}" alt="Toyota Camry {{ __('messages.o_similar') }}">
          </div>
        ...
        <article class="car-card">
          <header class="car-title">
            ...
            <p> Jeep Renegade {{ __('messages.o_similar') }} | IC</p>
          </header>
          <div class="car-media">
            <img src="{{ asset('img/renegade.png') }}" alt=" Jeep Renegade {{ __('messages.o_similar') }}">
          </div>
        ...
        <article class="car-card">
          <header class="car-title">
            ...
            <p>Volkswagen Taos {{ __('messages.o_similar') }} | I</p>
          </header>
          <div class="car-media">
            <img src="{{ asset('img/taos.png') }}" alt="Volkswagen Taos {{ __('messages.o_similar') }}">
          </div>
        ...
        <div class="fleet-track">
          <article class="car-card">
            <header class="car-title">
              ...
              <p>Toyota avanza {{ __('messages.o_similar') }} | IB</p>
            </header>
            <div class="car-media">
              <img src="{{ asset('img/avanza.png') }}" alt="Toyota avanza {{ __('messages.o_similar') }}">
            </div>
          ...
          <article class="car-card">
            <header class="car-title">
              ...
              <p> Honda Odyssey {{ __('messages.o_similar') }} | M</p>
            </header>
            <div class="car-media">
              <img src="{{ asset('img/Odyssey.png') }}" alt=" Honda Odyssey {{ __('messages.o_similar') }}">
            </div>
          ...
          <article class="car-card">
            <header class="car-title">
              ...
              <p>Nissan Urvan {{ __('messages.o_similar') }} | L | TM </p>
            </header>
            <div class="car-media">
              <img src="{{ asset('img/Urvan.png') }}" alt="Nissan Urvan {{ __('messages.o_similar') }}">
            </div>
          ...
          <article class="car-card">
            <header class="car-title">
              ...
              <p>Toyota Hiace {{ __('messages.o_similar') }} | L</p>
            </header>
            <div class="car-media">
              <img src="{{ asset('img/Hiace.png') }}" alt="Toyota Hiace {{ __('messages.o_similar') }}">
            </div>
          ...
          <article class="car-card">
            <header class="car-title">
              ...
              <p>Nissan Frontier {{ __('messages.o_similar') }} | E</p>
            </header>

            <div class="car-media">
              <img src="{{ asset('img/Frontier.png') }}" alt="Nissan Frontier {{ __('messages.o_similar') }}">
            </div>
          ...
          <article class="car-card">
            <header class="car-title">
              ...
              <p>Toyota Tacoma {{ __('messages.o_similar') }} | F</p>
            </header>
            <div class="car-media">
              <img src="{{ asset('img/Tacoma.png') }}" alt="Toyota Tacoma {{ __('messages.o_similar') }}">
            </div>
...
<div class="modal" id="welcomeModal" aria-hidden="true">
  ...
  <div class="modal-card" role="dialog" aria-modal="true" aria-labelledby="wmTitle">
    <button class="modal-close" id="wmClose" aria-label="{{ __('messages.cerrar') }}"><i class="fa-regular fa-circle-xmark"></i></button>
...
@section('js-vistaHome')
  ...
  {{-- ✅ Inicializar Select2 con placeholders traducidos --}}
  <script>
    $(document).ready(function() {
        $('#pickupPlace').select2({
            width: '100%',
            placeholder: '{{ __("messages.donde_inicia") }}'
        });
        $('#dropoffPlace').select2({
            width: '100%',
            placeholder: '{{ __("messages.donde_termina") }}'
        });
    });
  </script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      if (dropoffInput) {
          const dropoffPicker = flatpickr(dropoffInput, {
              dateFormat: "Y-m-d",
              altInput: true,
              altFormat: "d-M-Y",
              minDate: "today",
  ...
  document.addEventListener('DOMContentLoaded', function() {
      ...
      // ✅ TRADUCCIONES DIRECTAS DESDE PHP
      ...
      form.addEventListener("submit", function(e) {
          ...
          const selects = [
              { id: 'pickupPlace', msg: validacionTexts.ubicacion_requerida },
              { id: 'dropoffPlace', msg: validacionTexts.ubicacion_requerida }
          ];
          ...
          /* ===== 2. VALIDAR FECHAS ===== */
          const fechas = [
              { id: 'pickupDate', msg: validacionTexts.fecha_requerida },
              { id: 'dropoffDate', msg: validacionTexts.fecha_requerida }
          ];
          ...
          /* ===== 3. VALIDAR HORAS ===== */
          const horas = [
              { id: 'pickupTime', msg: validacionTexts.hora_requerida },
              { id: 'dropoffTime', msg: validacionTexts.hora_requerida }
          ];
  ...
  {{-- ✅ SELECTS DE HORA CON TRADUCCIONES --}}
<script>
(function() {
    "use strict";
    ...
    function createTimeSelectsBelow(input) {
        if (!input) return;

        const wrap = input.closest(".time-field");
        if (!wrap) return;
        ...
        selH.setAttribute("aria-label", "{{ __('messages.hora') }}");

        // Placeholder con el texto traducido
        selH.insertAdjacentHTML("afterbegin", `<option value="" disabled selected>{{ __('messages.hora') }}</option>`);

        // Llenamos con horas: 00-23
        for (let h = 0; h <= 23; h++) {
        ...
        function sync() {
            const finalH = selH.value ? pad2(selH.value) : '';
            input.value = finalH ? `${finalH}:00` : '';
    ...
    function initTimeFields() {
        ...
        if (pickupTime) createTimeSelectsBelow(pickupTime);
        if (dropoffTime) createTimeSelectsBelow(dropoffTime);
    }
    ...
    function updateSummary() {
        ...
        function parseDate(dateId, timeId) {
            ...
            if (timeInput && timeInput.value) {
                h = parseInt(timeInput.value.split(':')[0]) || 0;
            }

            return new Date(y, m - 1, d, h, 0);
        }

        const start = parseDate('pickupDate', 'pickupTime');
        const end = parseDate('dropoffDate', 'dropoffTime');
        ...
        rangeSummary.textContent = `{{ __('messages.renta_por') }} ${days} {{ __('messages.dias') }} · ~${hours} {{ __('messages.horas') }}`;
    }
    ...
    // Exponer función para actualizar
  ...
  (function(){
    const translations = {
      buscando_reserva: "{{ __('messages.buscando_reserva') }}",
      alguien_buscando: "{{ __('messages.alguien_buscando') }}",
      otra_reserva: "{{ __('messages.otra_reserva') }}",
      reservo_aeropuerto: "{{ __('messages.reservo_aeropuerto') }}",
      reservo_central: "{{ __('messages.reservo_central') }}",
      reservo_central_park: "{{ __('messages.reservo_central_park') }}"
    };

    const SEQ = [
      {
        title: translations.buscando_reserva,
        text: translations.alguien_buscando
      },
      {
        title: translations.otra_reserva,
        text: translations.reservo_aeropuerto
      },
      {
        title: translations.buscando_reserva,
        text: translations.alguien_buscando
      ...
      {
        title: translations.otra_reserva,
        text: translations.reservo_central
      },
      {
        title: translations.buscando_reserva,
        text: translations.alguien_buscando
      ...
      {
        title: translations.otra_reserva,
        text: translations.reservo_central_park
      }
    ];
